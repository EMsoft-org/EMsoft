...
public:
  ...
  //
  // -----------------------------------------------------------------------------
  template <typename T> herr_t testReadPointer1DArrayAttribute(hid_t file_id, const QString& dsetName)
  {
    T value = 0x0;
    herr_t err = -1;
    herr_t retErr = err;
  ...
  //
  // -----------------------------------------------------------------------------
  template <typename T> herr_t testWritePointer2DArrayAttribute(hid_t file_id, const QString& dsetName)
  {
  ...
  //
  // -----------------------------------------------------------------------------
  template <typename T> herr_t testReadPointer2DArrayAttribute(hid_t file_id, const QString& dsetName)
  {
    T value = 0x0;
    herr_t err = -1;
    herr_t retErr = err;
  ...
  //
  // -----------------------------------------------------------------------------
  template <typename T> herr_t testWritePointer3DArrayAttribute(hid_t file_id, const QString& dsetName)
  {
    T value = 0x0;
    herr_t err = -1;
    QString attributeKey = QH5Lite::HDFTypeForPrimitiveAsStr(value);
  ...
  //
  // -----------------------------------------------------------------------------
  template <typename T> herr_t testReadPointer3DArrayAttribute(hid_t file_id, const QString& dsetName)
  {
    T value = 0x0;
    herr_t err = -1;
    herr_t retErr = err;
  ...
  //
  // -----------------------------------------------------------------------------
  template <typename T> herr_t testWriteVectorAttribute(hid_t file_id, QString dsetName)
  {
    T value = 0x0;
    herr_t err = -1;
    QString attributeKey = QH5Lite::HDFTypeForPrimitiveAsStr(value);
  ...
  //
  // -----------------------------------------------------------------------------
  template <typename T> herr_t testReadVectorAttribute(hid_t file_id, QString dsetName)
  {
    T value = 0x0;
    herr_t err = -1;
    QString attributeKey = QH5Lite::HDFTypeForPrimitiveAsStr(value);
  ...
  //
  // -----------------------------------------------------------------------------
  template <typename T> herr_t testWriteScalarAttribute(hid_t file_id, const QString& dsetName)
  {
    T value = 0x0F;
    herr_t err = -1;
    QString attributeKey = QH5Lite::HDFTypeForPrimitiveAsStr(value);
  ...
  //
  // -----------------------------------------------------------------------------
  template <typename T> herr_t testReadScalarAttribute(hid_t file_id, const QString& dsetName)
  {
    T value = 0x0F;
    T refValue = value;
    herr_t err = -1;
  ...
  // -----------------------------------------------------------------------------
  template <typename T> herr_t testWritePointer2DArrayDataset(hid_t file_id)
  {
  ...
  //
  // -----------------------------------------------------------------------------
  template <typename T> herr_t testWriteVectorDataset(hid_t file_id)
  {
    T value = 0x0;
    herr_t err = 1;
  ...
  //
  // -----------------------------------------------------------------------------
  template <typename T> herr_t testReadVectorDataset(hid_t file_id)
  {
    T value = 0x0;
    herr_t err = 1;
  ...
  //
  // -----------------------------------------------------------------------------
  template <typename T> herr_t testWriteScalarDataset(hid_t file_id)
  {
    T value = 0x0F;
    herr_t err = 1;
  ...
  //
  // -----------------------------------------------------------------------------
  template <typename T> herr_t testReadScalarDataset(hid_t file_id)
  {
    T value = 0x0F;
    T refValue = value;
    herr_t err = 1;
  ...
  // -----------------------------------------------------------------------------
  template <typename T> herr_t testReadPointer2DArrayDataset(hid_t file_id)
  {
  ...
  //
  // -----------------------------------------------------------------------------
  template <typename T> void printData(QVector<T>& data, QVector<T>& rData)
  {
    // qDebug() << "Wrote/Read" << "\n";
...
#define TYPE_DETECTION(m_msgType, check)                                                                                                                                                               \
  ...
  void TestVLengStringReadWrite()
  {
    // Write a Single String as a VLength String and read back as a normal string.
    {
      ...
      file_id = QH5Utilities::openFile(UnitTest::H5LiteTest::VLengthFile, true);

      std::string data;
      err = H5Lite::readStringDataset(file_id, "VlenStrings", data);
      DREAM3D_REQUIRE(err > -1)
      DREAM3D_REQUIRE(data.size() == 13)
